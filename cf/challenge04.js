...
console.log('contains W 1--', containsW(str1));
console.log('contains W 2--', containsW(str2));
console.log('contains W 3--', containsW(str3));
...
let isNum1 = 1234567890;
let isNum2 = 'h3llo w0rld';
let isNum3 = 'hello world';
...
console.log('is number 1--', isNum(isNum1));
console.log('is number 2--', isNum(isNum2));
console.log('is number 3--', isNum(isNum3));
...
let worldStr1 = 'hello world';
let worldStr2 = 'Hello World';
let worldStr3 = 'hello everyone';

const containsWorld = (input) => {
  let regex = /world\b/gm;
  let answer = regex.test(input);
  return answer;
};

console.log('contains world 1--', containsWorld(worldStr1));
console.log('contains world 2--', containsWorld(worldStr2));
console.log('contains world 3--', containsWorld(worldStr3));
...
let isCap = 'We only want to Return the Words that begin With a capital Letter';
...
console.log('is capitalized--', isCapitalized(isCap));
...
console.log('cities A through J--', citiesAtoJ(cities));
