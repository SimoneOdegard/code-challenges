...
console.log('raised to the third --', raisedToTheThird(arr));
...
let str = 'This is my story.';

function theEnd(str) {
  let answer = str+'The end.';
  return answer;
}

console.log('the end --', theEnd(str));
...
function appendFirstToLast(array) {
  array.push(array[0]);
}

appendFirstToLast(array);

console.log('append first to last --', array);
...
let obj = { fullName: 'Octavia Butler' };
let year = 1947;
...
console.log('add birth year property--', obj);
...
let people = [{ fullName: 'Octavia Butler' }, { fullName: 'Ray Bradbury' }, { fullName: 'Kurt Vonnegut' }];
...
console.log('set status as author--', people);
