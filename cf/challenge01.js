...
console.log('addOne', addOne(arr));
console.log('addOne forEach', addOneForEach(arr));
...
// for loop
function addExclamationForLoop(stringArray) {
  let answer = [];
...
// forEach
function addExclamation(stringArray) {
  let answer = [];
...
console.log('addExclamation for loop', addExclamationForLoop(stringArray));
console.log('addExclamation forEach', addExclamation(stringArray));
...
// forEach
function allUpperCase(stringArray) {
  let answer = [];
  stringArray.forEach(i => {
...
console.log('all upper case', allUpperCase(stringArray));
...
console.log('greeting', greeting(stringArray));
console.log('speaker', speaker(stringArray));
...
function addNumbers(val, arr, numberOfTimes, addValues) {
...
console.log('add numbers', addNumbers(val, arr, numberOfTimes, addValues));
...
let inventory = [{ name: 'apples', available: true }, { name: 'pears', available: true }, { name: 'oranges', available: false }, { name: 'bananas', available: true }, { name: 'blueberries', available: false }]
...
console.log('create list', createList(inventory));
...
console.log('fizzbuzz', fizzbuzz(newArr));
