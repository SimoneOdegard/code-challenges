...
const toLastNames = people => {
  let answer = [];
  people.map((i) => answer.push(`${i.firstName} ${i.lastName}`));
  return answer
};

console.log('1. full name--', toLastNames(people));
...
console.log('2. pin is 4 digits--', validatePin(pin1));
...
console.log('3. is 5-10 word--', validateWord(word1));
...
console.log('4. has number--', hasNumber(numStr2));
...
let email1 = 'email@gmail.com';
let email2 = 'fjodijaf@yoyoyo.net';
let email3 = 'pandabear@bamboo.org';
let email4 = 'uhhhh@nothing.co';
...
console.log('5. validate email--', validateEmail(email4));
...
console.log('6. validate phone number--', validatePhoneNumber(phone));
