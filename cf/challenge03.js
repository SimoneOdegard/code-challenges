...
const updateAnimal = (arr, callback) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    let updated = callback(arr[i]);
    answer.push(updated);
  };
  return answer;
};

console.log('UPDATED ANIMAL--', updateAnimal(arr, upper));
console.log('updated animal--', updateAnimal(arr, lower));
...
let nameArr = ['able', 'Bob'];

function sortNames(nameArr) {
  return nameArr.sort();
}

console.log('sort names--', sortNames(nameArr));
...
let numberArr = [8, 3, 2, 9, 12, 1, 115];

const sortNumbers = (numberArr) => {
  return numberArr.sort((a, b) => a-b);
};

console.log('sort numbers--', sortNumbers(numberArr));
...
const sortBackwards = (numberArr) => {
  return numberArr.sort((a, b) => b-a);
};

console.log('sort backwards--', sortBackwards(numberArr));
...
let alphaArr1 = ['alphabet', 'Zebra', 'Alphabet', 'carrot'];
let alphaArr2 = ['alphabet','Alphabet', 'carrot'];
let alphaArr3 = [];

const alphabetize = (alphaArr1) => {
  return alphaArr1.sort();
};

console.log('alphabetize 1--', alphabetize(alphaArr1));
// console.log('alphabetize 2--', alphabetize(alphaArr2));
// console.log('alphabetize 3--', alphabetize(alphaArr3));
...
// ***** SORTS BY PRICE BUT LOSES KEY VALUE PAIRS *****
// const sortByPrice = (items) => {
//   let sortable = [];
//   for (let i = 0; i < items.length; i++) {
//     sortable.push(items[i].price);
//   }
//   sortable.sort();
//   return sortable;
// };

// don't need to loop through array. can use sort
function sortByPrice(items) {
  return items.sort((a, b) => (a.price - b.price))
}

console.log('sort by price--', sortByPrice(items));
...
let betterAlpha1 = ['Alice', 'apple', 'alert', 'Average'];
let betterAlpha2 = ['alphabet', 'Zebra', 'Alphabet', 'carrot'];

const alphabetizeBetter = (betterAlpha2) => {
  return betterAlpha2.sort((a, b) => a.toLowerCase() > b.toLowerCase() ? 1 : -1);
};

// if a > b is true it'll return 1, if false it'll return -1

// console.log('alphabetize better 1--', alphabetizeBetter(betterAlpha1));
console.log('alphabetize better 2--', alphabetizeBetter(betterAlpha2));
...
const sortByLength = (betterAlpha2) => {
  return betterAlpha2.sort((a, b) => a.length > b.length ? 1 : -1);
};

console.log('sort by length 1--', sortByLength(betterAlpha2));
...
let numberLength = [100, 2.8, 1, -47.75];

const sortNumbersByLength = (numberLength) => {
  return numberLength.sort((a, b) => a.toString().length > b.toString().length ? 1 : -1);
};

console.log('sort numbers by length--', sortNumbersByLength(numberLength));
...
const sortPeople = (people) => {
  return people.sort((a, b) => (a.lastName > b.lastName ? 1 : -1));
};

console.log('sort people--', sortPeople(people));
...
const sortPeopleBetter = (family) => {
  return family.sort((a, b) => (a.lastName > b.lastName ? 1 : -1 && a.firstName > b.firstName ? 1 : -1));
};

console.log('sort family--', sortPeopleBetter(family));
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((a,b) => a.dayOfWeek > b.dayOfWeek ? 1 : -1);
};

console.log('sort meeting days--', sortMeetingsByDay(meetings));
...
sortSchedule(meetings);

console.log('sort when meetings happen--', meetings);
