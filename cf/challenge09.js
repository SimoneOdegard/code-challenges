...
console.log('1. transform to list items', transformToLis(obj));
...
console.log('2. add values with reduce--', addValues(numArr));
...
console.log('3. add purchases--', addPurchases(purchases));
...
let randomArr = [12, 3, 1, 47, 43, 4, 2];
...
console.log('4. count elements--', countNumberOfElements(randomArr));
...
const returnNames = (arr) => {
  let answer = [];
  arr.reduce((answerSoFar, value, index) => {
    answer.push(value.name);
  }, []);
  return answer;
};

console.log('5. return names--', returnNames(starWarsData));
...
console.log('6. reverse str--', reversedString(reverse));
...
console.log('7. return number of children--', countNumberOfChildren(characters));
